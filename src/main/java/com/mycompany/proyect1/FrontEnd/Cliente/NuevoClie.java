 ...
 * @author ajolo
 */
public class NuevoClie extends javax.swing.JFrame {

    /**
     * Creates new form NuevoClie
     */
    public NuevoClie() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!nombre.isEmpty()) {
            ...
            String tmp = nombre + ";" + nit;

            new Util().escribirArchivo(tmp, Util.miRuta+"/clientes.txt" , true);
